...
setwd("/Users/prateekwadhwani/Desktop/NCSU Classwork/Spring '22/Algorithms for Data Guided Business Intelligence/Market Segmentation/Attributed Graph Compunity Detection Project Resources-20220307")
# ===== Reading the graph ====== #
...
conn <- file("communities_1.txt", open="r")
